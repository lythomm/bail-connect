...
export default function Navbar() {
  ...
  const excludedPaths = ["/signin", "/register", "/verify-email", "/cgu", "/cgv", "/confidentialite", "/mentions-legales"];
  const isExcluded =
  ...
  return (
    <>
              ...
              {isDropdownOpen && (
                ...
                >
                  <Link
                    ...
                    className={`flex items-center gap-2 px-4 py-2 text-sm transition-colors ${pathname === "/profile"
                  ...
                  <Link
                    href="/support"
                    onClick={() => setIsDropdownOpen(false)}
                    className={`flex items-center gap-2 px-4 py-2 text-sm transition-colors ${pathname === "/support"
                      ? "bg-[#F5F5FE] text-[#000091] font-semibold"
                      : "text-[#161616] hover:bg-[#F5F5FE] hover:text-[#000091]"
                      }`}
                  >
      ...
      {!isAuthenticated && (
        <div
          className={`fixed inset-x-0 bottom-0 top-16 bg-white z-40 flex flex-col justify-between px-6 py-8 md:hidden transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${isMobileMenuOpen
        ...
        >
          <nav className="flex flex-col gap-6 text-left">
            <Link
              ...
              className={`text-lg font-bold text-[#161616] hover:text-[#000091] py-1 transition-all duration-500 ${isMobileMenuOpen
          ...
          {/* Bottom CTAs */}
          <div
            className={`flex flex-col gap-3 pb-8 transition-all duration-500 ${isMobileMenuOpen
      ...
      {isAuthenticated && (
        <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-[#DDDDDD] h-16 flex items-center justify-around z-50 shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
          <Link
            href="/dashboard"
            className={`flex flex-col items-center justify-center gap-1 w-1/3 h-full text-[10px] font-medium transition-colors ${pathname === "/dashboard" ? "text-[#000091]" : "text-[#666666] hover:text-[#000091]"
              }`}
          >
          ...
          <Link
            href="/annonces"
            className={`flex flex-col items-center justify-center gap-1 w-1/3 h-full text-[10px] font-medium transition-colors ${pathname === "/annonces" || pathname?.startsWith("/dashboard/campaigns")
              ? "text-[#000091]"
          ...
          <Link
            href="/calendar"
            className={`flex flex-col items-center justify-center gap-1 w-1/3 h-full text-[10px] font-medium transition-colors ${pathname === "/calendar" ? "text-[#000091]" : "text-[#666666] hover:text-[#000091]"
              }`}
          >
